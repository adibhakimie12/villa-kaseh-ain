  ...
  return (
    <main className="bg-surface">
      <section className="relative h-[100svh] overflow-hidden md:h-screen">
        ...
        >
          <source src={content.heroMedia.video} type="video/mp4" />
        </video>
        ...
        <div className="absolute left-1/2 top-1/2 z-10 w-full max-w-[900px] -translate-x-1/2 -translate-y-1/2 px-5 text-center md:px-10">
          <div className="mx-auto flex w-full flex-col items-center">
            <p className="hero-fade hero-fade-kicker text-[10px] uppercase tracking-[0.36em] text-[#d6e7e3] md:text-[11px]">
              {content.siteConfig.locationShort}
            </p>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
            <div className="max-w-2xl">
              ...
              <h2 className="mt-4 font-headline text-4xl md:text-6xl">A slower kind of escape, where sea breeze and sunset do the healing.</h2>
            </div>
            <button
              type="button"
          ...
          <div className="mt-10 grid gap-4 md:mt-12 md:grid-cols-[1.05fr_0.95fr_0.95fr] md:grid-rows-2 md:gap-5">
            <div className="overflow-hidden rounded-[2rem] md:row-span-2">
              <img src={content.galleryImages[0]} alt="Villa Kaseh Ain" className="h-full min-h-[340px] w-full object-cover" loading="lazy" />
            </div>
            <div className="overflow-hidden rounded-[2rem]">
              <img src={content.galleryImages[1]} alt="Villa Kaseh Ain" className="h-56 w-full object-cover md:h-full" loading="lazy" />
            </div>
            <div className="overflow-hidden rounded-[2rem]">
              <img src={content.galleryImages[2]} alt="Villa Kaseh Ain" className="h-56 w-full object-cover md:h-full" loading="lazy" />
            </div>
            <div className="overflow-hidden rounded-[2rem] md:col-span-2">
              <img src={content.galleryImages[3]} alt="Villa Kaseh Ain" className="h-64 w-full object-cover md:h-[22rem]" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
        ...
        >
          ...
          >
            <div className="mb-5 flex items-center justify-between gap-4">
              <div>
                <p className="lux-kicker">Full Gallery</p>
                <h3 className="mt-2 font-headline text-3xl text-[#22312d] md:text-4xl">Moments from around the villa</h3>
              </div>
              <button
                type="button"
                onClick={() => setIsGalleryOpen(false)}
